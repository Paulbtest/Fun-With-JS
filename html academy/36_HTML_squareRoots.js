// HTML Academy. Испытание: "Квадратные корни"
...
let calculateRoots = function (a, b, c) {
    ...
    if (discriminant < 0) {
        ...
        result = 'Корень равен ' + Math.round(-b / (2 * a));
    } else {
        let firstRoot = Math.round((-b + Math.sqrt(discriminant)) / (2 * a));
        let secondRoot = Math.round((-b - Math.sqrt(discriminant)) / (2 * a));

        result = 'Первый корень равен ' + firstRoot + ', второй корень равен ' + secondRoot;
